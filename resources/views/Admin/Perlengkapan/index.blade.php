            ...
            <div class="card w-100">
              <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <h5 class="card-title fw-semibold mb-0">Manajemen Perlengkapan</h5>
                  <div>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Jenis Perlengkapan</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Jumlah Perlengkapan</h6>
                        </th>
                        <th class="border-bottom-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- Tombol Hapus -->
                          <a href="{{ route('tools.destroy', $item->id) }}" class="btn btn-outline-light m-1 hapus" data-id="{{ $item->id }}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="jenis_tools" class="form-label">Jenis Perlengkapan</label>
          <input  type="text" id="jenis_tools" name="jenis_tools" class="form-control" placeholder="Masukan Jenis Perlengkapan" required>
        </div>
        <div class="form-group">
          <label for="jumlah" class="form-label">Jumlah Perlengkapan</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="jenis_tools" class="form-label">Jenis Perlengkapan</label>
          <input  type="text" id="jenis_toolsDetail" name="jenis_tools" class="form-control" placeholder="Masukan Jenis Perlengkapan" required>
        </div>
        <div class="form-group">
          <label for="jumlah" class="form-label">Jumlah Perlengkapan</label>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Data Perlengkapan</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ route('tools.add') }}" method="POST"  enctype="multipart/form-data">
      @csrf
      <div class="modal-body">
        <div class="form-group">
          <label for="tanggal" class="form-label">Tanggal</label>
        ...
        <div class="form-group">
          <label for="jenis_tools" class="form-label">Jenis Perlengkapan</label>
          <input  type="text" name="jenis_tools" class="form-control" placeholder="Masukan Jenis Perlengkapan" required>
        </div>
        <div class="form-group">
          <label for="jumlah" class="form-label">Jumlah Perlengkapan</label>
  ...
  @extends('Admin.Perlengkapan.script')
</body>
</html>
